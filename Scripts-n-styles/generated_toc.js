...
generated_toc = {
  generate: function() {
    ...
    if (status && status == "open") {
      ...
      toggle_initially = "Rejtse el a tartalomjegyzéket";
    } else {
      display_initially = "none";
      toggle_initially = "Mutassa a tartalomjegyzéket";
    }
...
//    a.appendChild(document.createTextNode('skip table of contents'));
  ...
  wrapOpenClose: function(a, cur_list_el) {
    ...
    return function(e) {
      ...
      a.firstChild.nodeValue = (d == 'block' ? 'Mutassa' : 'Rejtse el') + ' a tartalomjegyzéket';
