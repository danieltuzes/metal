...
<body style="font-size:80%; font-family:Arial, Helvetica, sans-serif"><div style="width:50%; border:1px solid #666666; padding:20px; background-color:#E3E9F0">
  <div align="center">
    ...
    <p class="style1">Egyszerre csak az egyik programot tudod használni!<br />
...
<p>Add meg a bementi filet és szükség esetén hogy hány változós a polinomod! Lehetőség van első és másodrendű függvény illesztésére is. A függvény dimenzióját a program kitalálja. </p>
<p><label>
