...
$utolsof = $column - 2;
$fuggoindex = $column - 1;
echo "<br />$column oszlopú a mátrix. Ebből konvenciónk szerint az első " . $utolsof . " a függő változót, utolsó előtti a független változókat tartalmazza, az utolsó pedig a hibát.<br />";
...
echo "Az adatok kiírása(legfeljebb az első 10):<br />";
...
if ($rend ==1) {
	...
	echo "Az együtthatók rendre: konstans, x_1, x_2, ... , x_n:<br /><strong>";
	for ($i=0; $i <= $utolsof; $i++) {
		echo $param[$i] . "<br />";}
	echo "</strong>";
	echo "A mért független változók és az illesztett fügvény értékei rendre:<br />";
	for ($i=0; $i < $rows; $i++) { //ki vannak egészítve az adatok balról egyesekkel, később jön jól
	...
	echo "Az illesztendő paraméterek száma:" . $nofparam;
	echo "<br />Az együtthatók rendre: konstans, x_1, x_2, ... , x_n, x_1^2, x_2^2, ... , x_n^2, x_1*x_2, x_1*x_3:, ... , x_1*x_n, x_2*x_2, x_2*x_3 , ... , x_n-1*x_n , x_n*x_n<br /><strong>";
